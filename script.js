...
const fileContents = {
  "~/profile/about.txt":
    "Joel Beauregard\n\nComputer Science / Software Engineering student at the University of Texas at Arlington and two-time Oracle software engineering intern, focused on AI workflow automation, systems, networking, cloud infrastructure, cybersecurity, containers, and practical developer tooling.\n\nIn summer 2026, I architected an AI reporting agent that automated customer report onboarding from ticket to pull request. The system validated SparkSQL, generated queries from ticket-provided business logic when needed, persisted workflow state, and enforced validation and human approval gates. I also built and deployed three MCP data-catalog tools for data discovery, investigations, detector development, and schema-grounded query generation.\n\nAcross internships, research, and personal projects, a consistent theme in my work is turning complex technical inputs into reliable, inspectable workflows. I care about taking work through the full lifecycle: shaping the design, writing the implementation, validating it carefully, maintaining it thoughtfully, and communicating clearly enough that the people around me can move faster.",
  "~/profile/oracle.log":
    "Oracle | Software Engineering Intern | Summers 2025 & 2026\n\nSummer 2026 — AI Reporting & Data Catalog Systems\n- Architected and developed an AI reporting agent automating customer report onboarding from ticket to pull request.\n- Implemented SparkSQL validation with query generation from ticket-provided business logic when needed.\n- Designed a persisted state-machine orchestrator enforcing workflow execution, validation, and human approval gates.\n- Automated 20+ live customer requests and reduced report-onboarding time by approximately 94%.\n- Built and deployed three MCP data-catalog tools enabling data discovery, investigations, detector development, and schema-grounded SparkSQL generation across hot and cold storage.\n\nSummer 2025 — Network Traffic Analytics & Test Infrastructure\n- Researched, designed, and documented a Network Traffic Analytics feature for SR-IOV Virtual Cloud Network visibility on Oracle Private Cloud Appliance.\n- Built and validated infrastructure using Python, Bash, Podman, Kubernetes, CI/CD pipelines, Cisco switches, and Oracle PCA hardware.\n- Ported 180+ Network Controller tests into a MySQL-backed containerized framework.\n- Improved test performance by about 80% and strengthened diagnostics, edge-case coverage, and error handling.",
  "~/profile/experience.log":
    "Experience Overview\n\n1. Oracle - Software Engineering Intern, Summers 2025 & 2026\nBuilt production-minded systems across two internships. In 2026, I developed an AI reporting agent with SparkSQL validation and conditional generation, persisted state-machine orchestration, and human approval gates; applied it to 20+ live customer requests with an approximately 94% reduction in onboarding time; and deployed three MCP data-catalog tools. In 2025, I worked on Oracle PCA network visibility, containerized infrastructure, hardware validation, and large-scale unit-test modernization.\n\n2. Tacit Captions / The Hybrid Atelier - Research Assistant\nWorked with a six-person multidisciplinary team on a multi-modal caption rendering system for sensor-based feedback. Built Python + pandas data pipelines, implemented caption-generation logic, generated synchronized WebVTT captions, contributed to research writing, and connected implementation choices back to the literature on assistive and multi-modal captioning.\n\nAcross both experiences, the pattern is consistent: take complex technical inputs, validate them carefully, and turn them into systems that are easier for people to reason about and use.",
  "~/profile/skills.json":
    '{\n  "programming": ["Python", "Bash", "Java", "SQL", "SparkSQL", "C", "C++"],\n  "technical": ["MCP", "AI Agent Workflows", "State Machines", "Human Approval Gates", "Data Catalogs", "Ubuntu", "Podman", "Docker", "Git", "OCI", "Oracle PCA", "Kubernetes", "Helm Charts", "pandas", "PyTest", "SQLAlchemy"],\n  "focus": ["AI Workflow Automation", "Systems", "Networking", "Cloud Infrastructure", "Containers", "Developer Platforms", "Security", "Automation"]\n}',
  "~/profile/contact.vcf":
  ...
  "~/profile/projects/devserver.md":
    "DevServer\nsubtitle -> University-Focused Managed Linux Development Platform\nstatus -> ongoing active build\npage -> /projects/devserver/\n\nDevServer is a university-focused managed Linux development environment platform for coursework, projects, and shell-based workflows. The project is centered on practical academic developer infrastructure and reflects my interest in systems design, containers, Linux environments, security boundaries, maintainability, and platform engineering.\n\nHighlights:\n- Designing managed Linux workspaces for academic programs with isolated shell access, personal home directories, and practical remote development workflows.\n- Exploring professor-facing course support such as assignment distribution, skeleton-code workflows, and structured development expectations.\n- Thinking through security boundaries, maintainability, testing surfaces, and operational simplicity so the platform is useful for universities and course teams rather than just an abstract platform idea.\n- Treating it as a lifecycle problem, not just an implementation problem: product framing, architecture, supportability, and how the platform could make students and instructors more productive.\n\nWhy it matters:\nThis is one of the clearest examples of where I want to keep growing as an engineer: academic developer infrastructure, remote environments, Linux systems, and platform-oriented tooling that solves practical problems for real users.",
...
if (typedText && !prefersReducedMotion.matches) {
  const messages = [
    "init --focus ai-workflows software-engineering systems networking",
    "tracking -> cloud infrastructure network-visibility developer-platforms agentic workflows",
    "current_state: two-time oracle intern + building devserver"
  ];
  ...
  typedText.textContent = "focus: AI workflows, software engineering, systems, infrastructure";
}
...
const commandHandlers = {
  ...
  whoami: () =>
    appendResponse(
      "Joel Beauregard | Computer Science / Software Engineering student and two-time Oracle software engineering intern focused on AI workflow automation, systems, networking, cloud infrastructure, and developer platforms.\n\nMy 2026 Oracle work included an AI reporting agent that automated customer onboarding from ticket to pull request, SparkSQL validation and conditional generation, persisted workflow orchestration, and three deployed MCP data-catalog tools. I applied the agent to 20+ live customer requests and reduced onboarding time by approximately 94%.\n\nThe common thread across my work is building software that is reliable, inspectable, and useful in realistic environments—from AI-assisted engineering workflows and network visibility to DevServer, containerized validation, and remote Linux development."
    ),
  about: () =>
    appendResponse(fileContents["~/profile/about.txt"]),
  focus: () =>
    appendResponse(
      "Current focus areas:\n- AI workflow automation and agentic systems\n- Model Context Protocol and developer-facing tools\n- Systems and networking\n- Cloud infrastructure and platform-minded software\n- Containers and remote Linux environments\n- Security-aware tooling\n- Validation, testing, and workflow orchestration\n\nRight now I’m especially interested in reliable AI-assisted workflows: systems with explicit state, validation, approval gates, and access to grounded data. I’m also continuing to build close to infrastructure through DevServer, networking tools, containers, and cloud platforms."
    ),
  experience: () =>
  ...
  skills: () =>
    appendResponse(
      "Technical toolkit\n\nProgramming and data:\n- Python, Bash, Java, C, C++, SQL, SparkSQL, MySQL\n\nAI workflows:\n- Model Context Protocol (MCP), AI agent workflows, state-machine orchestration, human approval gates, data catalogs, schema-grounded query generation\n\nContainers and platforms:\n- Docker, Podman, Kubernetes, Helm Charts, OCI, Oracle PCA, Ubuntu, Linux, computer virtualization\n\nData and testing:\n- pandas, SQLAlchemy, PyTest, relational modeling, query design, MySQL-backed validation workflows\n\nSystems and networking:\n- VCNs, networking fundamentals, cloud / infrastructure concepts, developer tooling, remote environments, automation scripts\n\nI tend to combine these tools to make complex workflows repeatable, observable, and reliable—from agentic systems with explicit validation to containerized tests and managed development environments."
    ),
  education: () =>
    appendResponse(
